...
class ProjectScanner:
    ...
    LAYER_PATTERNS = {
        'presentation': ['controller', 'handler', 'view', 'page', 'component', 'ui', 'SmartChart', 'ChatMessage', 'SmartInsight'],
        'api': ['api', 'route', 'endpoint', 'rest', 'graphql'],
        'business': ['service', 'usecase', 'domain', 'logic', 'core', 'utils'],
        'data': ['repository', 'dao', 'model', 'entity', 'schema', 'migration', 'constants'],
