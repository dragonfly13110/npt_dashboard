...
function summaryToStats(summary) {
  ...
  return {
    ...
    lc: metrics.learningCenters || 0,
    pc: metrics.pestCenters || 0,
    sfc: metrics.soilFertilizerCenters || 0,
    instHousewives: metrics.housewifeGroups || 0,
    instYoung: metrics.youngFarmerGroups || 0,
    instCareer: metrics.careerGroups || 0,
