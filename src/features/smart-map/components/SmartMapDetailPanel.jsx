...
export default function SmartMapDetailPanel({
  ...
  return (
    ...
    >
      ...
      <div className="panel-section" role="tablist" aria-label="ข้อมูลพื้นที่">
        <button
          role="tab"
      ...
      {activeTab === 'analysis' && (
        <>
          <div className="panel-section" role="note">
            ...
            <div className="panel-section policy-simulation">
              ...
              <div className="simulation-results-grid">
                {[
                  ...
                  <div
                    className={`sim-result-card ${className}`}
                    key={className}
                  >
          ...
          <div className="panel-section">
            ...
            <div className="panel-stats-grid">
              {[
                [
                  '⚠️',
                  selectedData.disasterArea || 0,
                  'พื้นที่ภัยพิบัติ (ไร่)',
                ],
