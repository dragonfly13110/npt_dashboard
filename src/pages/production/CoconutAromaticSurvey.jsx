...
import { BarChartOutlined, FileExcelOutlined, PlusOutlined, ReloadOutlined, UploadOutlined } from '@ant-design/icons';
...
export default function CoconutAromaticSurvey() {
  ...
  const handleImport = async (file) => {
    try {
      ...
      const sheet = workbook.Sheets['แบบเก็บข้อมูล 11.05.69'] || workbook.Sheets[workbook.SheetNames[0]];
    ...
    <div>
      ...
      <Card style={{ marginBottom: 20 }}>
        <Space wrap>
          ...
          {userCanEdit && <Upload accept=".xlsx,.xls" showUploadList={false} beforeUpload={handleImport}><Button icon={<UploadOutlined />}>Import Excel</Button></Upload>}
