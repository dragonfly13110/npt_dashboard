...
export default function CropProduction() {
    useEffect(() => {
        document.title = 'ผลผลิตพืชเศรษฐกิจนครปฐม | ศูนย์ข้อมูลการเกษตรนครปฐม';
        const meta = document.querySelector('meta[name="description"]');
        if (meta) meta.setAttribute('content', 'ข้อมูลผลผลิตพืชเศรษฐกิจจังหวัดนครปฐม แยกตามพืช อำเภอ และปี พร้อมตารางค้นหา');
    }, []);
