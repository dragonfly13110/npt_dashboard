...
const columns = [
  ...
  {
    title: 'หมู่บ้าน',
    dataIndex: 'villages_count',
    key: 'villages_count',
    width: 80,
    align: 'right',
    importHeader: 'จำนวนหมู่บ้าน',
    render: (val) => (val != null ? Number(val).toLocaleString() : '-'),
  },
  {
    title: 'ตำบล',
    dataIndex: 'subdistricts_count',
    key: 'subdistricts_count',
    width: 70,
    align: 'right',
    importHeader: 'จำนวนตำบล',
    render: (val) => (val != null ? Number(val).toLocaleString() : '-'),
  },
  {
    title: (
    ...
    importHeader: 'จำนวนครัวเรือนเกษตรกร_ครัวเรือน',
    dataIndex: 'farmer_households',
    key: 'farmer_households',
    width: 100,
    align: 'right',
    render: (val) => (val != null ? Number(val).toLocaleString() : '-'),
  },
  {
    ...
    importHeader: 'พื้นที่ทั้งหมด_ไร่',
    dataIndex: 'total_area_rai',
    key: 'total_area_rai',
    width: 100,
    align: 'right',
    render: (val) => (val != null ? Number(val).toLocaleString() : '-'),
  },
  {
    ...
    importHeader: 'พื้นที่การเกษตรด้านพืช_ไร่',
    dataIndex: 'agri_crop_area_rai',
    key: 'agri_crop_area_rai',
    width: 100,
    align: 'right',
    render: (val) => (val != null ? Number(val).toLocaleString() : '-'),
  },
  {
    title: 'ข้าวนาปี',
    dataIndex: 'rice_in_season_rai',
    key: 'rice_in_season_rai',
    width: 90,
    align: 'right',
    importHeader: 'ข้าวนาปี_ไร่',
    render: (val) => (val != null ? Number(val).toLocaleString() : '-'),
  },
  {
    title: 'ข้าวนาปรัง',
    dataIndex: 'rice_off_season_rai',
    key: 'rice_off_season_rai',
    width: 90,
    align: 'right',
    importHeader: 'ข้าวนาปรัง_ไร่',
    render: (val) => (val != null ? Number(val).toLocaleString() : '-'),
  },
  {
    title: 'พืชไร่',
    dataIndex: 'field_crops_rai',
    key: 'field_crops_rai',
    width: 80,
    align: 'right',
    importHeader: 'พืชไร่_ไร่',
    render: (val) => (val != null ? Number(val).toLocaleString() : '-'),
  },
  {
    title: 'พืชสวน',
    dataIndex: 'horticulture_rai',
    key: 'horticulture_rai',
    width: 80,
    align: 'right',
    importHeader: 'พืชสวน_ไร่',
    render: (val) => (val != null ? Number(val).toLocaleString() : '-'),
  },
  {
    title: (
    ...
    importHeader: 'ไม้ผลไม้ยืนต้น_ไร่',
    dataIndex: 'fruit_trees_rai',
    key: 'fruit_trees_rai',
    width: 90,
    align: 'right',
    render: (val) => (val != null ? Number(val).toLocaleString() : '-'),
  ...
  {
    title: 'พืชผัก',
    dataIndex: 'vegetables_rai',
    key: 'vegetables_rai',
    width: 80,
    align: 'right',
    importHeader: 'พืชผัก_ไร่',
    render: (val) => (val != null ? Number(val).toLocaleString() : '-'),
  },
  {
    title: (
    ...
    importHeader: 'ไม้ดอกไม้ประดับ_ไร่',
    dataIndex: 'flowers_rai',
    key: 'flowers_rai',
    width: 90,
    align: 'right',
    render: (val) => (val != null ? Number(val).toLocaleString() : '-'),
  },
  {
    ...
    importHeader: 'สมุนไพรเครื่องเทศ_ไร่',
    dataIndex: 'herbs_spices_rai',
    key: 'herbs_spices_rai',
    width: 90,
    align: 'right',
    render: (val) => (val != null ? Number(val).toLocaleString() : '-'),
  },
...
const formFields = (
  ...
  >
    ...
    <Form.Item name="villages_count" label="จำนวนหมู่บ้าน">
      <InputNumber style={{ width: '100%' }} />
    </Form.Item>
    <Form.Item name="subdistricts_count" label="จำนวนตำบล">
      <InputNumber style={{ width: '100%' }} />
    </Form.Item>
    <Form.Item name="farmer_households" label="จำนวนครัวเรือนเกษตรกร_ครัวเรือน">
      <InputNumber style={{ width: '100%' }} />
    </Form.Item>
    <Form.Item name="total_area_rai" label="พื้นที่ทั้งหมด_ไร่">
      <InputNumber style={{ width: '100%' }} />
    </Form.Item>
    <Form.Item name="agri_crop_area_rai" label="พื้นที่การเกษตรด้านพืช_ไร่">
      <InputNumber style={{ width: '100%' }} />
    </Form.Item>
    <Form.Item name="rice_in_season_rai" label="ข้าวนาปี_ไร่">
      <InputNumber style={{ width: '100%' }} />
    </Form.Item>
    <Form.Item name="rice_off_season_rai" label="ข้าวนาปรัง_ไร่">
      <InputNumber style={{ width: '100%' }} />
    </Form.Item>
    <Form.Item name="field_crops_rai" label="พืชไร่_ไร่">
      <InputNumber style={{ width: '100%' }} />
    </Form.Item>
    <Form.Item name="horticulture_rai" label="พืชสวน_ไร่">
      <InputNumber style={{ width: '100%' }} />
    </Form.Item>
    <Form.Item name="fruit_trees_rai" label="ไม้ผลไม้ยืนต้น_ไร่">
      <InputNumber style={{ width: '100%' }} />
    </Form.Item>
    <Form.Item name="vegetables_rai" label="พืชผัก_ไร่">
      <InputNumber style={{ width: '100%' }} />
    </Form.Item>
    <Form.Item name="flowers_rai" label="ไม้ดอกไม้ประดับ_ไร่">
      <InputNumber style={{ width: '100%' }} />
    </Form.Item>
    <Form.Item name="herbs_spices_rai" label="สมุนไพรเครื่องเทศ_ไร่">
      <InputNumber style={{ width: '100%' }} />
    </Form.Item>
  </div>
);
...
const CROP_TYPES = [
  {
    key: 'rice_in_season_rai',
    label: 'ข้าวนาปี',
    color: CROP_COLORS['ข้าวนาปี'],
  },
  {
    key: 'rice_off_season_rai',
    label: 'ข้าวนาปรัง',
    color: CROP_COLORS['ข้าวนาปรัง'],
  },
  { key: 'field_crops_rai', label: 'พืชไร่', color: CROP_COLORS['พืชไร่'] },
  { key: 'horticulture_rai', label: 'พืชสวน', color: CROP_COLORS['พืชสวน'] },
  {
    key: 'fruit_trees_rai',
    label: 'ไม้ผลไม้ยืนต้น',
    color: CROP_COLORS['ไม้ผลไม้ยืนต้น'],
  },
  { key: 'vegetables_rai', label: 'พืชผัก', color: CROP_COLORS['พืชผัก'] },
  {
    key: 'flowers_rai',
    label: 'ไม้ดอกไม้ประดับ',
    color: CROP_COLORS['ไม้ดอกไม้ประดับ'],
  },
  {
    key: 'herbs_spices_rai',
    label: 'สมุนไพรเครื่องเทศ',
    color: CROP_COLORS['สมุนไพรเครื่องเทศ'],
  },
];
...
export default function AgriculturalAreas() {
  useEffect(() => {
    ...
    if (meta)
      meta.setAttribute(
        'content',
        'สรุปพื้นที่การเกษตรของจังหวัดนครปฐม แยกตามอำเภอและชนิดพืช พร้อมข้อมูลตารางค้นหาและกราฟสรุป'
      );
  }, []);
  ...
  const districtOptions = useMemo(() => {
    const unique = [
      ...new Set(chartData.map((d) => d.district).filter(Boolean)),
    ].sort();
  ...
  const pieOption = useMemo(() => {
    ...
    return {
      tooltip: {
        ...
        padding: [12, 16],
        extraCssText:
          'box-shadow: 0 4px 20px rgba(0,0,0,0.12); border-radius: 10px; min-width: 220px; max-height: 320px; overflow-y: auto;',
        textStyle: {
          color: '#0f172a',
          fontSize: 12,
        ...
        formatter: (params) => {
          ...
          const cropColor =
            pieData.find((d) => d.name === params.name)?.color || '#16a34a';
          ...
          const distHtml = districtRows
            .map(
              (d, i) =>
                ...
                ' <span style="color:#94a3b8; font-weight:400; font-size:10px;">ไร่</span>' +
                '</strong></div>'
            )
            .join('');
          ...
          return (
            '<div style="font-weight:700; font-size:13px; margin-bottom:8px; padding-bottom:6px; border-bottom:2px solid ' +
            cropColor +
            '40; color:#1e293b; display:flex; align-items:center; gap:6px;">' +
            ...
            ' ไร่ <span style="color:#94a3b8; font-weight:400;">(' +
            params.percent +
            '%)</span></strong>' +
            '</div>'
          );
            ...
            onEachFeature={(feature, layer) => {
              ...
              if (distName) {
                  ...
                  const cropRows = [
                    {
                      icon: '🌾',
                      label: 'ข้าวนาปี',
                      val: chartStats.rice_in_season_rai,
                    },
                    {
                      icon: '🌾',
                      label: 'ข้าวนาปรัง',
                      val: chartStats.rice_off_season_rai,
                    },
                    {
                      icon: '🌽',
                      label: 'พืชไร่',
                      val: chartStats.field_crops_rai,
                    },
                    {
                      icon: '🌿',
                      label: 'พืชสวน',
                      val: chartStats.horticulture_rai,
                    },
                    {
                      icon: '🍎',
                      label: 'ไม้ผล/ยืนต้น',
                      val: chartStats.fruit_trees_rai,
                    },
                    {
                      icon: '🥬',
                      label: 'พืชผัก',
                      val: chartStats.vegetables_rai,
                    },
                    {
                      icon: '🌸',
                      label: 'ไม้ดอก/ประดับ',
                      val: chartStats.flowers_rai,
                    },
                    {
                      icon: '🌿',
                      label: 'สมุนไพร',
                      val: chartStats.herbs_spices_rai,
                    },
                  ].filter((r) => Number(r.val) > 0);

                  const cropGridHtml = cropRows
                    .map(
                      (r) =>
                ...
                layer.on({
                  ...
                  click: () => {
                    setFilterDistrict((prev) =>
                      prev === distName ? null : distName
                    );
                  },
                });
              }
  ...
  return (
    <div>
      ...
      <div className="agri-areas-page-header">
        ...
        <p>
          วิเคราะห์ข้อมูลพื้นที่เพาะปลูกพืชเศรษฐกิจแยกรายอำเภอและชนิดพืช (เช่น
          ข้าวนาปี, ข้าวนาปรัง, พืชสวน, ผัก, ไม้ดอกไม้ประดับ)
          พร้อมตารางสถิติและสัดส่วนพื้นที่
        </p>
      </div>
              ...
              <div className="agri-kpi-grid agri-kpi-grid--compact">
                <div className="agri-kpi-card green-theme">
                  ...
                  <div className="kpi-content">
                    <span className="kpi-label">
                      พื้นที่เพาะปลูกพืช
                      {hasActiveFilter ? ` (อ.${filterDistrict})` : 'รวม'}
                    </span>
                    <span className="kpi-value">
                      {totals.cropArea.toLocaleString()}
                      <small>ไร่</small>
                    </span>
                  </div>
                </div>
                ...
                <div className="agri-kpi-card blue-theme">
                  ...
                  <div className="kpi-content">
                    ...
                    <span className="kpi-value">
                      {totals.villages.toLocaleString()}
                      <small>หมู่บ้าน</small>
                    </span>
                  </div>
                </div>
                <div className="agri-kpi-card purple-theme">
                  ...
                  <div className="kpi-content">
                    ...
                    <span className="kpi-value">
                      {totals.subdistricts.toLocaleString()}
                      <small>ตำบล</small>
                    </span>
                  </div>
                </div>
