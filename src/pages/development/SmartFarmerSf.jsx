...
const columns = [
  ...
  },
  {
    ...
    key: 'citizen_id',
    width: 160,
    importHeader: 'เลขบัตรประชาชน',
    sorter: (a, b) =>
      String(a.citizen_id || '').localeCompare(
        String(b.citizen_id || ''),
        'th'
      ),
  },
  ...
  },
  {
    ...
    key: 'province',
    width: 120,
    importHeader: 'จังหวัด_จากที่อยู่',
    sorter: (a, b) =>
  ...
  },
  {
    ...
    width: 180,
    importHeader: 'การได้รับการรับรองมาตรฐานการผลิต',
    sorter: (a, b) =>
  ...
  },
  {
    ...
    key: 'sales_channel',
    width: 180,
    importHeader: 'ช่องทางการจำหน่ายผลผลิต/สินค้า',
    sorter: (a, b) =>
...
export default function SmartFarmerSf() {
  ...
  const { createRecord, updateRecord, deleteRecord } =
    useSupabaseCrud('smart_farmer_sf');
  ...
  const fetchRows = async () => {
    const { data, error } = await supabase
      ...
      .select(getPublicSelectColumns('smart_farmer_sf', columns, role))
  ...
  const {
    ...
    isLoading,
    refetch,
  } = useApiCache(['smart_farmer_sf_all', role], fetchRows);
  const years = useMemo(
    () =>
  ...
  const activityData = useMemo(
    () => countBy(filteredRows, 'agricultural_activity', 10),
    [filteredRows]
  );
  ...
  const baseVisibleColumns = useMemo(
    () =>
      getPublicColumns('smart_farmer_sf', columns, role)
        .filter(
          (column) =>
    ...
    <div>
      ...
      >
        ...
        <Row gutter={[24, 24]}>
          ...
          <Col xs={24} lg={12}>
            <Card
              title="กิจกรรมทางการเกษตรยอดนิยม"
              size="small"
              bordered={false}
              style={{ background: '#fafbfc' }}
            >
              <div style={{ height: 320 }}>
                <EChart
                  option={barOption(
                    ...
                    { layout: 'vertical', unit: 'ราย', grid: { left: 118 } }
                  )}
                />
              </div>
            </Card>
