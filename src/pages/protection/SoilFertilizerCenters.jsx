...
const formFields = (
  <>
    <Form.Item name="cert_date" label="วันที่ออกหนังสือรับรอง">
      <Input placeholder="เช่น 12/5/2021" />
    </Form.Item>
    ...
    <Form.Item name="grade_level" label="ระดับ">
      <Input placeholder="เช่น A+, A, B" />
    </Form.Item>
    ...
    <Form.Item name="chairman" label="ประธาน/ผู้แทน">
      <Input placeholder="เช่น นาย... หรือ รองประธาน รักษาการแทนประธาน" />
    </Form.Item>
    <Form.Item name="contact_phone" label="เบอร์โทรศัพท์">
      <Input />
    </Form.Item>
    <Form.Item name="member_count" label="จำนวนสมาชิก_ราย">
      <InputNumber style={{ width: '100%' }} />
    </Form.Item>
    <Form.Item name="main_crop_type" label="พืชหลัก">
      <Input />
    </Form.Item>
    <Form.Item name="group_type" label="กลุ่มประเภท">
      <Input placeholder="เช่น ศดปช.หลัก, ศดปช.เครือข่าย" />
    </Form.Item>
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: 16, fontWeight: 700, color: '#1f2328' }}>
            สรุปข้อมูลศูนย์จัดการดินปุ๋ยชุมชน (ศดปช.)
          </span>
          <Tag color="green">
            {hasActiveFilter
