...
const GROUP_TABLES = {
    ...
    development: ['community_enterprises', 'smart_farmers', 'smart_farmer_sf', 'farmer_groups', 'housewife_farmer_groups', 'young_farmer_groups', 'young_farmer_groups_detailed', 'agri_tourism', 'disasters'],
