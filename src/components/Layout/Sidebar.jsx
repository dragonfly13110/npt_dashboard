...
const allMenuItems = [
    ...
    children: [
      {
        ...
        label: 'Dashboard กลุ่ม',
      },
      {
        key: '/dashboard/admin/personnel',
        icon: <TeamOutlined />,
        label: 'ข้อมูลบุคลากร',
      },
      {
        key: '/dashboard/admin/assets',
        icon: <CarOutlined />,
        label: 'พัสดุ/ครุภัณฑ์',
      },
      {
        key: '/dashboard/admin/budgets',
        icon: <DollarOutlined />,
        label: 'งบประมาณ',
      },
    ],
  },
  {
    ...
    group: 'strategy',
    icon: <AimOutlined />,
    label: 'กลุ่มยุทธศาสตร์และสารสนเทศ',
    children: [
      {
        key: '/dashboard/strategy/overview',
        icon: <PieChartOutlined />,
        label: 'Dashboard กลุ่ม',
      },
      {
        key: '/dashboard/strategy/farmer-registry',
        icon: <FileTextOutlined />,
  ...
  },
  {
    ...
    group: 'production',
    icon: <BankOutlined />,
    label: 'กลุ่มส่งเสริมและพัฒนาการผลิต',
    children: [
      {
        key: '/dashboard/production/overview',
        icon: <PieChartOutlined />,
        label: 'Dashboard กลุ่ม',
      },
      {
        key: '/dashboard/production/large-plots',
        icon: <BankOutlined />,
        label: 'แปลงใหญ่',
      },
      {
        key: '/dashboard/production/certifications',
        icon: <SafetyCertificateOutlined />,
        label: 'มาตรฐาน GAP',
      },
      {
        key: '/dashboard/production/crop-production',
  ...
  },
  {
    ...
    group: 'development',
    icon: <ShopOutlined />,
    label: 'กลุ่มส่งเสริมและพัฒนาเกษตรกร',
    children: [
      {
        key: '/dashboard/development/overview',
        icon: <PieChartOutlined />,
        label: 'Dashboard กลุ่ม',
      },
      {
        key: '/dashboard/development/community-enterprises',
        icon: <ShopOutlined />,
        label: 'วิสาหกิจชุมชน',
      },
      {
        key: '/dashboard/development/smart-farmer-sf',
        icon: <UserSwitchOutlined />,
        label: 'เกษตรกรปราดเปรื่อง (SF)',
      },
      {
        key: '/dashboard/development/young-smart-farmer-ysf',
        icon: <UserSwitchOutlined />,
        label: 'เกษตรกรรุ่นใหม่ (YSF)',
      },
      {
        key: '/dashboard/development/agricultural-career-groups',
        icon: <UsergroupAddOutlined />,
        label: 'กลุ่มส่งเสริมอาชีพการเกษตร',
      },
      {
        key: '/dashboard/development/housewife-farmer-groups',
        icon: <UsergroupAddOutlined />,
        label: 'กลุ่มแม่บ้านเกษตรกร',
      },
      {
        key: '/dashboard/development/young-farmer-groups',
        icon: <UsergroupAddOutlined />,
      ...
      {
        key: '/dashboard/development/disasters',
  ...
  },
  {
    ...
    group: 'protection',
    icon: <BugOutlined />,
    label: 'กลุ่มอารักขาพืช',
    children: [
      {
        key: '/dashboard/protection/overview',
        icon: <PieChartOutlined />,
        label: 'Dashboard กลุ่ม',
      },
      {
        key: '/dashboard/protection/pest-outbreaks',
        icon: <BugOutlined />,
        label: 'แปลงพยากรณ์',
      },
      {
        key: '/dashboard/protection/disease-forecast',
        icon: <AlertOutlined />,
        label: 'พยากรณ์โรค & แมลง',
      },
      {
        key: '/dashboard/protection/pest-centers',
        icon: <MedicineBoxOutlined />,
        label: 'ศจช.',
      },
      {
        key: '/dashboard/protection/plant-doctors',
        icon: <MedicineBoxOutlined />,
        label: 'หมอพืช',
      },
      {
        key: '/dashboard/protection/soil-fertilizer',
...
const adminOnlyItems = [
  { type: 'divider' },
  {
    ...
    children: [
      ...
      {
        key: '/dashboard/admin/recent-activities',
        icon: <HistoryOutlined />,
        label: 'กิจกรรมล่าสุดทั้งหมด',
      },
    ],
  },
];
