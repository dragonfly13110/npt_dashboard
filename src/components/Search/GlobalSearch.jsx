...
import {
    SearchOutlined, RightOutlined, DatabaseOutlined,
    ClockCircleOutlined, CloseOutlined, DeleteOutlined
...
const SEARCH_SUGGESTIONS = [
    'กำแพงแสน', 'ข้าว', 'GAP', 'แปลงใหญ่',
    'วิสาหกิจ', 'Smart Farmer', 'ศพก', 'สามพราน',
];
    ...
    const dropdownContent = open && (
        ...
        >
            ...
            {!loading && showRecent && (
                <div className="global-search-recent">
                    <div className="global-search-section-header">
                        <span><ClockCircleOutlined /> ค้นหาล่าสุด</span>
            ...
            {!loading && showSuggestions && (
                <div className="global-search-recent">
                    <div className="global-search-section-header">
                        <span><SearchOutlined /> ลองค้นหา</span>
                    </div>
                    <div className="global-search-tags">
            ...
            {!loading && showResults && results.length > 0 && (
                <>
                    <div className="global-search-header">
                        <DatabaseOutlined />
                        <span>พบ <strong>{totalResults.toLocaleString()}</strong> รายการ จาก <strong>{results.length}</strong> ตาราง</span>
                    </div>
            ...
            <div className="global-search-hint">
                <span><kbd>Enter</kbd> ดูทั้งหมด</span>
                <span><kbd>Esc</kbd> ปิด</span>
                <span><kbd>Ctrl+K</kbd> เปิดค้นหา</span>
            </div>
        </div>
    );
    ...
    return (
        <div ref={containerRef} className="global-search-container">
            <Input
                ...
                allowClear={{
                    clearIcon: <CloseOutlined style={{ color: 'rgba(255, 255, 255, 0.6)' }} />,
                }}
