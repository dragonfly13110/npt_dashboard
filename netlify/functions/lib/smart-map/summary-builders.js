...
const SOURCE_TABLES = {
  ...
  learningCenters: 'learning_centers',
  pestCenters: 'pest_centers',
  soilFertilizerCenters: 'soil_fertilizer_centers',
...
function summaryForScope(scope, datasets = {}) {
  ...
  return {
    ...
    metrics: {
      ...
      learningCenters: rows.learningCenters.length,
      pestCenters: rows.pestCenters.length,
      soilFertilizerCenters: rows.soilFertilizerCenters.length,
      housewifeGroups: rows.housewifeGroups.length,
      youngFarmerGroups: rows.youngFarmerGroups.length,
      careerGroups: rows.careerGroups.length,
      groupCount: groups,
