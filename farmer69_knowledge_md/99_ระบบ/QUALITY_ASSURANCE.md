...
slug: farmer69-quality-assurance
...
- จำนวนบทความที่อ่านได้: 114
- จำนวน FAQ: 119
- จำนวน RAG chunks: 986
- จำนวนหน้า PDF ที่มีใน source-pages.json: 90/90
- ชั้นถอดต้นฉบับตามหน้า PDF: 90 ไฟล์ Markdown พร้อม YAML และ source marker
