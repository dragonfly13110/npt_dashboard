...
│   │   ├── production/              # หน้าข้อมูลกลุ่มส่งเสริมการผลิต (แปลงใหญ่, ใบรับรอง GAP, ผลผลิตพืช)
...
| **ส่งเสริมการผลิต (Production)** | `large_plots`, `certifications`, `crop_production`                                                                                                                                                              | ข้อมูลพืชแปลงใหญ่ จำนวนใบรับรองมาตรฐาน GAP และสัดส่วนพืชหลัก                                                                     |
