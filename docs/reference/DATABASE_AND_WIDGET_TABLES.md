...
| ส่งเสริมการผลิต | `coconut_aromatic_surveys`     |         แบบสำรวจมะพร้าวน้ำหอม |           1 | ข้อมูลต้นทุนและผลผลิตมะพร้าวน้ำหอมราย 20 วัน |
...
| `CoconutSurveyCard`     | `coconut_aromatic_surveys`                                                                                                                                                                                                                                                                                                                                                                                                           | ข้อมูลต้นทุน ราคา รายได้ของมะพร้าวน้ำหอม            |
