...
1. รัน E2E บน Staging/Production ให้ครบ Admin, Editor, District Editor และ Guest — local ผ่านครบ 4 บทบาทแล้ว; เหลือรันบน environment จริง
...
- [ ] **ขยาย E2E Tests**
  ...
  - [ ] Staging/Production: รันซ้ำด้วยบัญชีทดสอบและตรวจสิทธิ์จริง
