...
3. ~~ลบ `xlsx` ที่ไม่มี security patch, ปิด Excel import และใช้ CSV สำหรับ import/export~~
4. เพิ่ม external uptime monitoring — มี `/api/health`, data freshness SLA และ LINE alert รายวันแล้ว
