  ...
  FOR cfg IN
    ...
    FROM (
      VALUES
        ...
        ('farmer_groups'::text, ARRAY['group_name','group_type','district','chairman','notes']::text[], ARRAY['id','group_name','group_type','district','chairman','member_count','notes','created_at','updated_at']::text[]),
        ...
        ('young_farmer_groups'::text, ARRAY['group_name','district','chairman','notes']::text[], ARRAY['id','group_name','district','chairman','member_count','notes','created_at','updated_at']::text[]),
