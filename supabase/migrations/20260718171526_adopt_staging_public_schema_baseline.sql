  ...
  SELECT COALESCE((
    SELECT
      ...
      OR (
        ...
        AND (
          (
            department = 'เธเนเธฒเธขเธเธฃเธดเธซเธฒเธฃเธ—เธฑเนเธงเนเธ'
            AND target_table = ANY (ARRAY['personnel', 'assets', 'budgets'])
          )
          OR (
            department = 'เธเธฅเธธเนเธกเธขเธธเธ—เธเธจเธฒเธชเธ•เธฃเนเนเธฅเธฐเธชเธฒเธฃเธชเธเน€เธ—เธจ'
          ...
          OR (
            department = 'เธเธฅเธธเนเธกเธชเนเธเน€เธชเธฃเธดเธกเนเธฅเธฐเธเธฑเธ’เธเธฒเธเธฒเธฃเธเธฅเธดเธ•'
            AND target_table = ANY (ARRAY[
              'large_plots',
              'certifications',
              'crop_production',
          ...
          OR (
            department = 'เธเธฅเธธเนเธกเธชเนเธเน€เธชเธฃเธดเธกเนเธฅเธฐเธเธฑเธ’เธเธฒเน€เธเธฉเธ•เธฃเธเธฃ'
            AND target_table = ANY (ARRAY[
          ...
          OR (
            department = 'เธเธฅเธธเนเธกเธญเธฒเธฃเธฑเธเธเธฒเธเธทเธ'
            AND target_table = ANY (ARRAY[
              'forecast_plots',
              'pest_outbreaks',
              'pest_centers',
...
BEGIN
  ...
  LOOP
    ...
    -- Exclude offices from personnel unless 'เน€เธเธเน€เธเธ“เน€เธยเน€เธเธ‘เน€เธยเน€เธยเน€เธเธ’เน€เธย' is explicitly in cleaned_terms
    IF cfg.table_name = 'personnel' THEN
      IF NOT EXISTS (
        SELECT 1
        FROM unnest(COALESCE(cleaned_terms, ARRAY[]::text[])) AS term
        WHERE term ILIKE '%เน€เธเธเน€เธเธ“เน€เธยเน€เธเธ‘เน€เธยเน€เธยเน€เธเธ’เน€เธย%'
      ) THEN
        where_sql := format('(%s) AND position IS DISTINCT FROM ''เน€เธเธเน€เธเธ“เน€เธยเน€เธเธ‘เน€เธยเน€เธยเน€เธเธ’เน€เธย''', where_sql);
      END IF;
    END IF;
...
CREATE OR REPLACE FUNCTION "public"."recalculate_province_total"() RETURNS "trigger"
    ...
    AS $$
        ...
        BEGIN
            ...
            IF TG_OP != 'DELETE' AND NEW.district = 'เธเธฑเธเธซเธงเธฑเธ”เธเธเธฃเธเธเธก' THEN
                RETURN NEW;
            END IF;
            IF TG_OP = 'DELETE' AND OLD.district = 'เธเธฑเธเธซเธงเธฑเธ”เธเธเธฃเธเธเธก' THEN
                RETURN OLD;
            END IF;
            ...
            WHERE data_year = target_year AND district = 'เธเธฑเธเธซเธงเธฑเธ”เธเธเธฃเธเธเธก';
            ...
            SELECT
                'เธเธฑเธเธซเธงเธฑเธ”เธเธเธฃเธเธเธก',
                target_year,
                max_cutoff,
...
CREATE TABLE IF NOT EXISTS "public"."assets" (
    ...
    "serial_number" "text",
    "location" "text",
    "condition" "text" DEFAULT 'เนเธเนเธเธฒเธเนเธ”เน'::"text",
    "value" numeric,
    "notes" "text",
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"()
...
CREATE TABLE IF NOT EXISTS "public"."budgets" (
    ...
    "status" "text" DEFAULT 'เธ”เธณเน€เธเธดเธเธเธฒเธฃ'::"text",
    "notes" "text",
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
...
CREATE OR REPLACE VIEW "public"."farmer_institutes" AS
 WITH "districts" AS (
         SELECT "unnest"(ARRAY['เน€เธกเธทเธญเธเธเธเธฃเธเธเธก'::"text", 'เธเธณเนเธเธเนเธชเธ'::"text", 'เธเธเธฃเธเธฑเธขเธจเธฃเธต'::"text", 'เธ”เธญเธเธ•เธนเธก'::"text", 'เธเธฒเธเน€เธฅเธ'::"text", 'เธชเธฒเธกเธเธฃเธฒเธ'::"text", 'เธเธธเธ—เธเธกเธ“เธ‘เธฅ'::"text"]) AS "district"
        ), "ce_counts" AS (
 ...
 SELECT "row_number"() OVER () AS "id",
    ...
    COALESCE("career"."count", 0) AS "career_promotion_groups",
        CASE "d"."district"
            WHEN 'เน€เธกเธทเธญเธเธเธเธฃเธเธเธก'::"text" THEN 210
            WHEN 'เธเธณเนเธเธเนเธชเธ'::"text" THEN 204
            WHEN 'เธเธเธฃเธเธฑเธขเธจเธฃเธต'::"text" THEN 98
            WHEN 'เธ”เธญเธเธ•เธนเธก'::"text" THEN 69
            WHEN 'เธเธฒเธเน€เธฅเธ'::"text" THEN 179
            WHEN 'เธชเธฒเธกเธเธฃเธฒเธ'::"text" THEN 137
            WHEN 'เธเธธเธ—เธเธกเธ“เธ‘เธฅ'::"text" THEN 21
            ELSE 0
...
CREATE TABLE IF NOT EXISTS "public"."forecast_plots" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "row_number" integer,
    "province" "text" DEFAULT 'เธเธเธฃเธเธเธก'::"text",
    "district" "text",
    "subdistrict" "text",
    "village_no" integer,
    "owner_name" "text",
...
CREATE TABLE IF NOT EXISTS "public"."geoplots_parcel_progress" (
    ...
    "province" "text" DEFAULT 'เธเธเธฃเธเธเธก'::"text" NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."line_user_preferences" (
    ...
    CONSTRAINT "line_user_preferences_district_check" CHECK ((("district" IS NULL) OR ("district" = ANY (ARRAY['เน€เธกเธทเธญเธเธเธเธฃเธเธเธก'::"text", 'เธเธณเนเธเธเนเธชเธ'::"text", 'เธเธเธฃเธเธฑเธขเธจเธฃเธต'::"text", 'เธ”เธญเธเธ•เธนเธก'::"text", 'เธเธฒเธเน€เธฅเธ'::"text", 'เธชเธฒเธกเธเธฃเธฒเธ'::"text", 'เธเธธเธ—เธเธกเธ“เธ‘เธฅ'::"text"])))),
...
CREATE TABLE IF NOT EXISTS "public"."personnel" (
    ...
    "phone" "text",
    "email" "text",
    "status" "text" DEFAULT 'เธเธเธดเธเธฑเธ•เธดเธเธฒเธ'::"text",
    "notes" "text",
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    "province" "text",
...
CREATE TABLE IF NOT EXISTS "public"."production_costs" (
    ...
    "source_file" "text" DEFAULT 'เธ•เนเธเธ—เธธเธเธเธฒเธฃเธเธฅเธดเธ• เธเธต 2567.xlsx'::"text",
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"()
);
...
CREATE INDEX "idx_gin_agri_tourism_description" ON "public"."agri_tourism" USING "gin" ("description" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_agri_tourism_district" ON "public"."agri_tourism" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_agri_tourism_spot_name" ON "public"."agri_tourism" USING "gin" ("spot_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_agri_tourism_spot_type" ON "public"."agri_tourism" USING "gin" ("spot_type" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_agricultural_areas_district" ON "public"."agricultural_areas" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_ai_forecasts_summary" ON "public"."ai_disease_forecasts" USING "gin" ("summary" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_assets_category" ON "public"."assets" USING "gin" ("category" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_assets_condition" ON "public"."assets" USING "gin" ("condition" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_assets_location" ON "public"."assets" USING "gin" ("location" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_assets_name" ON "public"."assets" USING "gin" ("name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_assets_notes" ON "public"."assets" USING "gin" ("notes" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_assets_serial" ON "public"."assets" USING "gin" ("serial_number" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_biocontrol_stock_notes" ON "public"."biocontrol_stock" USING "gin" ("notes" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_biocontrol_stock_period" ON "public"."biocontrol_stock" USING "gin" ("period" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_biocontrol_stock_product" ON "public"."biocontrol_stock" USING "gin" ("product_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_biocontrol_stock_source" ON "public"."biocontrol_stock" USING "gin" ("source" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_biocontrol_stock_status" ON "public"."biocontrol_stock" USING "gin" ("status" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_budgets_project_name" ON "public"."budgets" USING "gin" ("project_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_budgets_source" ON "public"."budgets" USING "gin" ("budget_source" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_budgets_status" ON "public"."budgets" USING "gin" ("status" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_career_groups_activity" ON "public"."agricultural_career_groups" USING "gin" ("activity" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_career_groups_ce_reg" ON "public"."agricultural_career_groups" USING "gin" ("community_enterprise_registration" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_career_groups_district" ON "public"."agricultural_career_groups" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_career_groups_group_name" ON "public"."agricultural_career_groups" USING "gin" ("group_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_career_groups_main_activity" ON "public"."agricultural_career_groups" USING "gin" ("main_activity" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_career_groups_potential" ON "public"."agricultural_career_groups" USING "gin" ("potential_level" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_career_groups_record_code" ON "public"."agricultural_career_groups" USING "gin" ("record_code" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_career_groups_standard" ON "public"."agricultural_career_groups" USING "gin" ("production_standard" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_career_groups_subdistrict" ON "public"."agricultural_career_groups" USING "gin" ("subdistrict" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_certifications_crop_name" ON "public"."certifications" USING "gin" ("crop_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_certifications_farmer_district" ON "public"."certifications" USING "gin" ("farmer_district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_certifications_farmer_name" ON "public"."certifications" USING "gin" ("farmer_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_certifications_plot_type" ON "public"."certifications" USING "gin" ("plot_type" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_community_enterprises_district" ON "public"."community_enterprises" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_community_enterprises_level" ON "public"."community_enterprises" USING "gin" ("level" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_community_enterprises_name" ON "public"."community_enterprises" USING "gin" ("enterprise_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_community_enterprises_product" ON "public"."community_enterprises" USING "gin" ("product_type" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_community_enterprises_subdistrict" ON "public"."community_enterprises" USING "gin" ("subdistrict" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_community_enterprises_type" ON "public"."community_enterprises" USING "gin" ("enterprise_type" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_crop_production_crop_name" ON "public"."crop_production" USING "gin" ("crop_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_crop_production_district" ON "public"."crop_production" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_crop_production_harvest_period" ON "public"."crop_production" USING "gin" ("harvest_period" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_disasters_district" ON "public"."disasters" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_disasters_subdistrict" ON "public"."disasters" USING "gin" ("subdistrict" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_disasters_type" ON "public"."disasters" USING "gin" ("disaster_type" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_farmer_groups_chairman" ON "public"."farmer_groups" USING "gin" ("chairman" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_farmer_groups_district" ON "public"."farmer_groups" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_farmer_groups_group_name" ON "public"."farmer_groups" USING "gin" ("group_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_farmer_groups_notes" ON "public"."farmer_groups" USING "gin" ("notes" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_farmer_groups_type" ON "public"."farmer_groups" USING "gin" ("group_type" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_farmer_registry_district" ON "public"."farmer_registry" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_farmer_registry_main_crop" ON "public"."farmer_registry" USING "gin" ("main_crop" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_fire_hotspots_district" ON "public"."fire_hotspots" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_fire_hotspots_risk_level" ON "public"."fire_hotspots" USING "gin" ("risk_level" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_fire_hotspots_spot_name" ON "public"."fire_hotspots" USING "gin" ("spot_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_forecast_plots_crop_type" ON "public"."forecast_plots" USING "gin" ("crop_type" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_forecast_plots_district" ON "public"."forecast_plots" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_forecast_plots_subdistrict" ON "public"."forecast_plots" USING "gin" ("subdistrict" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_forecast_plots_variety" ON "public"."forecast_plots" USING "gin" ("variety" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_gis_areas_area_name" ON "public"."gis_areas" USING "gin" ("area_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_gis_areas_area_type" ON "public"."gis_areas" USING "gin" ("area_type" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_gis_areas_district" ON "public"."gis_areas" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_gis_areas_notes" ON "public"."gis_areas" USING "gin" ("notes" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_housewife_groups_activity" ON "public"."housewife_farmer_groups" USING "gin" ("activity" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_housewife_groups_ce_reg" ON "public"."housewife_farmer_groups" USING "gin" ("community_enterprise_registration" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_housewife_groups_chairman" ON "public"."housewife_farmer_groups" USING "gin" ("chairman" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_housewife_groups_district" ON "public"."housewife_farmer_groups" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_housewife_groups_group_name" ON "public"."housewife_farmer_groups" USING "gin" ("group_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_housewife_groups_potential" ON "public"."housewife_farmer_groups" USING "gin" ("potential_level" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_housewife_groups_standard" ON "public"."housewife_farmer_groups" USING "gin" ("production_standard" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_housewife_groups_subdistrict" ON "public"."housewife_farmer_groups" USING "gin" ("subdistrict" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_large_plots_agency" ON "public"."large_plots" USING "gin" ("agency" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_large_plots_commodity" ON "public"."large_plots" USING "gin" ("commodity" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_large_plots_district" ON "public"."large_plots" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_large_plots_plot_name" ON "public"."large_plots" USING "gin" ("plot_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_large_plots_secondary_commodity" ON "public"."large_plots" USING "gin" ("secondary_commodity" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_large_plots_subdistrict" ON "public"."large_plots" USING "gin" ("subdistrict" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_learning_centers_district" ON "public"."learning_centers" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_learning_centers_name" ON "public"."learning_centers" USING "gin" ("name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_personnel_department" ON "public"."personnel" USING "gin" ("department" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_personnel_district" ON "public"."personnel" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_personnel_office_type" ON "public"."personnel" USING "gin" ("office_type" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_personnel_position" ON "public"."personnel" USING "gin" ("position" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_pest_centers_chairman" ON "public"."pest_centers" USING "gin" ("chairman" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_pest_centers_district" ON "public"."pest_centers" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_pest_centers_main_crop" ON "public"."pest_centers" USING "gin" ("main_crop_type" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_pest_centers_name" ON "public"."pest_centers" USING "gin" ("center_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_pest_centers_subdistrict" ON "public"."pest_centers" USING "gin" ("subdistrict" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_pest_outbreaks_crop" ON "public"."pest_outbreaks" USING "gin" ("affected_crop" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_pest_outbreaks_district" ON "public"."pest_outbreaks" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_pest_outbreaks_name" ON "public"."pest_outbreaks" USING "gin" ("pest_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_pest_outbreaks_notes" ON "public"."pest_outbreaks" USING "gin" ("notes" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_pest_outbreaks_report_date" ON "public"."pest_outbreaks" USING "gin" ("report_date" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_pest_outbreaks_severity" ON "public"."pest_outbreaks" USING "gin" ("severity" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_plant_doctors_district" ON "public"."plant_doctors" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_plant_doctors_province" ON "public"."plant_doctors" USING "gin" ("province" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_plant_doctors_subdistrict" ON "public"."plant_doctors" USING "gin" ("subdistrict" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_production_costs_crop_name" ON "public"."production_costs" USING "gin" ("crop_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_smart_farmer_sf_activity" ON "public"."smart_farmer_sf" USING "gin" ("agricultural_activity" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_smart_farmer_sf_district" ON "public"."smart_farmer_sf" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_smart_farmer_sf_province" ON "public"."smart_farmer_sf" USING "gin" ("province" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_smart_farmer_sf_record_code" ON "public"."smart_farmer_sf" USING "gin" ("record_code" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_smart_farmer_sf_standard" ON "public"."smart_farmer_sf" USING "gin" ("production_standard" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_smart_farmer_sf_status" ON "public"."smart_farmer_sf" USING "gin" ("farmer_status" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_smart_farmers_district" ON "public"."smart_farmers" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_smart_farmers_farmer_type" ON "public"."smart_farmers" USING "gin" ("farmer_type" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_smart_farmers_main_product" ON "public"."smart_farmers" USING "gin" ("main_product" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_soil_centers_chairman" ON "public"."soil_fertilizer_centers" USING "gin" ("chairman" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_soil_centers_district" ON "public"."soil_fertilizer_centers" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_soil_centers_main_crop" ON "public"."soil_fertilizer_centers" USING "gin" ("main_crop_type" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_soil_centers_name" ON "public"."soil_fertilizer_centers" USING "gin" ("center_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_soil_centers_subdistrict" ON "public"."soil_fertilizer_centers" USING "gin" ("subdistrict" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_soil_series_code" ON "public"."soil_series" USING "gin" ("soil_series_code" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_soil_series_district" ON "public"."soil_series" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_soil_series_fertility" ON "public"."soil_series" USING "gin" ("fertility" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_soil_series_group" ON "public"."soil_series" USING "gin" ("soil_group" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_soil_series_name" ON "public"."soil_series" USING "gin" ("soil_series_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_soil_series_ph_top" ON "public"."soil_series" USING "gin" ("ph_top" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_soil_series_texture" ON "public"."soil_series" USING "gin" ("texture" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_young_farmer_groups_chairman" ON "public"."young_farmer_groups" USING "gin" ("chairman" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_young_farmer_groups_district" ON "public"."young_farmer_groups" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_young_farmer_groups_name" ON "public"."young_farmer_groups" USING "gin" ("group_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_young_farmer_groups_notes" ON "public"."young_farmer_groups" USING "gin" ("notes" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_young_groups_activity" ON "public"."young_farmer_groups_detailed" USING "gin" ("activity" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_young_groups_district" ON "public"."young_farmer_groups_detailed" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_young_groups_group_name" ON "public"."young_farmer_groups_detailed" USING "gin" ("group_name" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_young_groups_potential" ON "public"."young_farmer_groups_detailed" USING "gin" ("potential_level" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_young_groups_record_code" ON "public"."young_farmer_groups_detailed" USING "gin" ("record_code" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_young_groups_subdistrict" ON "public"."young_farmer_groups_detailed" USING "gin" ("subdistrict" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_ysf_activity" ON "public"."young_smart_farmer_ysf" USING "gin" ("agricultural_activity" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_ysf_district" ON "public"."young_smart_farmer_ysf" USING "gin" ("district" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_ysf_province" ON "public"."young_smart_farmer_ysf" USING "gin" ("province" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_ysf_record_code" ON "public"."young_smart_farmer_ysf" USING "gin" ("record_code" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_ysf_standard" ON "public"."young_smart_farmer_ysf" USING "gin" ("production_standard" "extensions"."gin_trgm_ops");



CREATE INDEX "idx_gin_ysf_status" ON "public"."young_smart_farmer_ysf" USING "gin" ("farmer_status" "extensions"."gin_trgm_ops");
...
-- Required before the snapshot creates its trigram GIN indexes.
